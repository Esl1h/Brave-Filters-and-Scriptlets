...
- youtube to https://github.com/TeamPiped/Piped[Piped]
- reddit to https://github.com/redlib-org/redlib[Redlib]
- tiktok to https://github.com/pablouser1/ProxiTok[ProxiTok]
